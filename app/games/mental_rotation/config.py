...
SHAPES: dict[str, list[tuple[int, int]]] = {
    ...
    "T6": [(0, 0), (1, 0), (2, 0), (0, 1), (1, 1)]
}

LEVEL_PARAMS: dict[int, dict] = {
    1: {"angle_min": 15, "angle_max": 45, "shape_ids": ["T1", "T2"], "display_ms": 2000, "mirror_prob": 0.00},
    ...
    4: {"angle_min": 105, "angle_max": 135, "shape_ids": ["T1", "T2", "T3", "T4", "T5"], "display_ms": 1400, "mirror_prob": 0.40},
    5: {"angle_min": 135, "angle_max": 165, "shape_ids": ["T1", "T2", "T3", "T4", "T5", "T6"], "display_ms": 1200, "mirror_prob": 0.50},
    6: {"angle_min": 165, "angle_max": 180, "shape_ids": ["T1", "T2", "T3", "T4", "T5", "T6"], "display_ms": 1000, "mirror_prob": 0.60},
}
